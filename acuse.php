<?php
// acuse.php - Endpoint directo e independiente de acuse de recibo sin dependencias de framework

// Evitar bloqueos de caché en navegadores o CDNs
...
if (!empty($token)) {
    // Configuración directa PDO para máxima velocidad e independencia
    $host = 'localhost';
    $dbname = 'uybntujx_tic';
    $user = 'root';
    $dbPass = (getenv('TIC_DB_PASS') ?: 'B.quilla54');

    try {
        $pdo = new PDO("mysql:host=$host;dbname=$dbname;charset=utf8mb4", $user, $dbPass, [
            PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
            PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_ASSOC
        ]);

        // Consultar token en log_correos_acuses
    ...
    <div class="card">
        ...
        <?php if ($detalles): ?>
            <div class="details-container">
                ...
                <div class="details-row">
                    <span>Estado:</span>
                    <span class="badge"><?= htmlspecialchars($detalles['estado_acuse']) ?></span>
                </div>
