...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Title -->
		<title>Restablecer contraseña &minus;System-Center</title>
									  		...
									  		$html = '<div class="row" style="border: solid 2px #214a81;border-radius: 26px;">
												...
												<form id="frmCambiarContraseña" method="POST" class="form-horizontal">
												    ...
												    <input type="hidden" name="txtEmail" id="txtEmail" value= '.$email.'>
													            ...
													            <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-10-desktop" style="margin-right:80px;">
													                <input style="float: right" type="checkbox" id="cbox1"><a style="float: right">Ver contraseña</a>	
													            </div>
													            
		                                                 <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-10">
		                                                   <button type="button" class="mdc-button mdc-button--raised w-100" onclick="Confirmar();">Cambiar contraseña</button>
                                                		</div>
													</div>
												</form>
											</div>';
