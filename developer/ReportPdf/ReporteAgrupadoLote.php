...
if ($chk==1){
    ...
    $pdf->Cell(30,5, utf8_decode('LOTE'), 1,0,'C', 'true');
    $pdf->Cell(30,5, utf8_decode('ETAPA'), 1,0,'C', 'true');
    ...
    if (!$query->rowCount() == 0){
        while ($fila = $query->fetch()){
               ...
               $pdf->Cell(30,5,utf8_decode((trim($fila['codigo']))), 1,0,'C');
               $pdf->Cell(30,5,utf8_decode((trim($fila['etapa']))), 1,0,'C');
