...
<html class="no-js" lang="zxx">
    ...
    <body>
			...
			<div class="container" style="margin-top: 35px;">
												...
												<form id="frmCambiarContraseña" method="POST" class="form-horizontal">
												    ...
												    <input type="hidden" name="txtEmail" id="txtEmail" value= '.$email.'>
		                                                 ...
		                                                 <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
		                                                   <button type="button" class="mdc-button mdc-button--raised w-100" onclick="ConfirmarPass();">Cambiar contraseña</button>
                                                		</div>
													</div>
												</form>
											</div>';
					  ...
					  <div class="desactivarC" style="height: 100%;width: 100%;position: fixed;top: 0;left: 0;background: rgba(255,255,255,0.7); z-index: 100;display:none;">
					  <img src="../assets/images/loading.gif" style="margin-left:50%; margin-top:300px;width: 60px;"></div>
