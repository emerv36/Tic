    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="row">
                <div class="col-md-11">
                    <div class="box-header">
                        <h1 class="box-title">Registro de Empresas:</h1>
                    </div>
                </div>
            ...
            <div class="box-body table-responsive ">
                ...
                <table class="table table-hover table-striped table-condesed" id="tbl_empresas" width="100%">
                ...
                <div class="row">
                    <form id="Editar-Sedes" method="POST">
                        ...
                        <div class="input-item col-xs-12">
                            <label for="txtnombresede">Nombre Empresa
...
<div class="modal fade" id="registrar-sede">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <form id="Registrar-Sedes" method="POST">
                        ...
                        <div class="input-item col-xs-12">
                            <label for="txtRegistraSede">Nombre Empresa:
                                <span class="required">*</span>
                            </label>
                        </div>
                        <div class="input-item col-xs-12">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-primary" onclick="RegistrarEmpresa();">Guardar</button>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <section>
                        <p class="mensajeconfirm" style="text-align:center"></p>
                    </section>
                </div>
            </div>
            <div class="modal-footer">
...
<script src="javascripts/gestionarsedes.js?v=jfhsikjdidshfshghsjfhasjhfjhbabfkbafbsfbabfafkjbakjfbjhabfjabfbkjkjkasfbajhf"></script>